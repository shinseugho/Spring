...
<head>
	...
	<!-- CSS files -->
	<link rel="stylesheet" href="../views/project/css/plugins.css">
	<link rel="stylesheet" href="../views/project/css/style.css">
...
<script src="../views/project/js/jquery.js"></script>
<script src="../views/project/js/plugins.js"></script>
<script src="../views/project/js/plugins2.js"></script>
<script src="../views/project/js/custom.js"></script>
</body>
